...
class TestNumericalFrameInstance(DeepQaTestCase):

    embedded_label_str = "0.0891758,0.121832,-0.0671959,0.0477279,-0.013659,-0.0671959,0.0640559,-0.0331269 , " \
                              "-0.0364239,0.00565199,-0.017113,-0.10362,0.0552639,-0.00706499,-0.0643699," \
                              "0.110528,-0.108644,0.00374837,-0.020567,-0.0464719,-0.015386,0.0979678,-0.023864," \
...
class TestIndexedFrameInstance(DeepQaTestCase):
    ...
    def test_words_from_frame_aggregated_correctly(self):
        ...
        assert (indexed_instance.label == TestNumericalFrameInstance.embedded_label).any()
